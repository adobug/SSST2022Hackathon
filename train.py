...
#modelsave = m.save('/home/adobug/Projects/webapptest/' + model_name)

m.load_weights("benign-vs-malignant_64_rmsprop_0.406.h5")
history = m.fit(train_ds, validation_data=valid_ds, 
                steps_per_epoch=n_training_samples // batch_size, 
                validation_steps=n_validation_samples // batch_size, verbose=1, epochs=1,#100
                callbacks=[tensorboard, modelcheckpoint])

#modelsave = m.save('/home/adobug/Projects/webapptest/joemama')
# evaluation
# load testing set

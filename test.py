...
cv2.dnn.writeTextGraph('/home/adobug/Projects/webapptest/saved_model/saved_model.pb', 'graph.pbtxt')
#pre_model = tf.keras.models.load_model(("mymodel-2.h5"),custom_objects={'KerasLayer':hub.KerasLayer})
...
pb_file = 'joemama/saved_model.pb'
...
graphdef_to_pbtxt('/home/adobug/Projects/webapptest/joemama/saved_model.pb')  # here you can write the name of the file to be converted
...
if __name__=='__main__':
    path = "/home/adobug/Projects/webapptest/saved_model/saved_model.pb"
    graph = load_model()
